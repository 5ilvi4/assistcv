...
- Led and automated Merchant Order Taking process by supporting 2 AI Products: deployment, user adoption, and product iteration:
  - Chatbot-Order Taking Automation: 10k onboarded merchant and 250bio revenue in 3 months.
  - Call-bot Order Taking Automation: 2k onboarded merchant and 20bio revenue in 3 months.
...
- Supported and automated core process of Alodokter by leading and maintaining 6 AI/ML Products:
  - Chatbot Automation: Binary Classification and Multi-class classification, scaling for 1 million users per month during Covid-19.
  - Aloweb Recommender System: Doctors' Recommender (Clustering).
  - Almobile Recommender System: Health Articles Recommender (Clustering and CTR).
  ...
  - Feeds Recommender: Collaborative Filtering, Content Based and Hybrid Based-LightFM.
...
- Leveraged data to understand business needs by conducting end-to-end analysis including data gathering, analysis, ongoing scaled deliverables, reports and presentations: growth, retention, revenue.
- Deployed and monitored Data Governance process: Implementing Trackers (SDK) to LinkAja User Journey metrics, preparing required data points and acceptance criteria using MixPanel and Braze.
- Led Automation Projects by utilizing Artificial Intelligence to implement growth initiatives with Product, Marketing and Sales Operations Teams:
  - Users' eKYC Automation (tampered, deblurring, 4 Points Transformation) – automating 80% of the process.
...
- Led the delivery of acceptance criteria and key milestones: Fraud Alert Monitoring, DevOps Log Monitoring, Marketing Automation for Marketing Group, eKYC Process for Operation Group, Reporting for Finance Group.

**Business Intelligence Analyst** | GOJEK – Data Science | 2019
- Analyzed and detected fraud patterns behavior by users, drivers, and merchants.
- Led and formulated Fraud Detection automation system for Fraud Operation Team: successfully preventing losses of around $5 million USD.
- Prepared insights and reports using statistical tools, data visualization and business use cases for business team: transactional, in-app behavior, and other behavioral data.
...
- Demonstrated an understanding of how Big Data should be processed in a platform that can handle the variety, velocity, and volume of data by using components that require integration and data governance.

**Data Science Math Skills** | Duke University | September 2019
- Applied basic math skills for Data Science: set theory, graphing functions, rate of change, exponents, logarithms, probability theory including Bayes' theorem.

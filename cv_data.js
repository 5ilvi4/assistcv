...
**Computer Science 101** | Stanford University | 2016 – 2018`
  ...
  {
    key:       "msft-tpm-aiml",
    label:     "Microsoft — TPM Generalist (AI/ML)",
    company:   "Microsoft",
    role:      "Technical Program Manager - Generalist (AI/ML)",
    jdUrl:     "https://apply.careers.microsoft.com/careers/job/1970393556637655?utm_source=linkedin&domain=microsoft.com&src=LinkedIn",
    dateAdded: "2026-03-28",
    cv: `#! SILVIA ADINDA
##! adinda@stanford.edu  •  650 305 6683  •  linkedin.com/in/silviatariganadinda  •  github.com/5ilvi4  •  Los Altos Hills, California

Technical Program Manager with 8+ years driving AI/ML programs from 0→1 across healthcare, fintech, and consumer tech. Track record of managing cross-functional programs spanning engineering, research, and product teams — 20 countries deployed, AI products at millions-of-users scale. Hands-on with Python, SQL/BigQuery, data pipelines, and AI tooling (Microsoft Copilot, LLMs). Comfortable owning complex programs across offices, teams, and time zones.
...
I am applying for the Technical Program Manager role on the MAI Superintelligence Team.

I want to be honest about why this role caught my attention: it is the framing. Most AI job descriptions talk about scale and speed. This one talks about building AI that is controllable, safety-aligned, and genuinely in service to humanity. That is not marketing language to me. I am finishing a Master in Medical Informatics at Stanford School of Medicine, and a big part of what I study is exactly how AI gets deployed in high-stakes settings where getting it wrong has real consequences for real people. The MAIST mission of Humanist Superintelligence is the version of this work I actually want to contribute to.

On the program side, I have spent the last several years running technical programs that span research, engineering, and product in parallel. At GE Healthcare I owned the technology deployment roadmap across 20 countries, which meant coordinating business alignment, system development, and user adoption across multiple teams and time zones at the same time. At Alodokter I managed the full AI/ML product roadmap: six products in production, data pipelines handling patient EMR data, model training, and a chatbot serving one million users a month during Covid. I know what the data-to-training-to-serving pipeline looks like in practice, not just on paper.

I also genuinely enjoy the 0-to-1 phase. At Philip Morris International I took two AI products from nothing to market in three months, onboarding ten thousand merchants. I like finding the path through complexity when there is no playbook yet.

Outside of work, I have been building medical AI projects because I find the problem interesting: ColpoAI for cervical cancer detection in low-resource clinics, and a Prior Authorization Auto-Assembler that uses agentic AI to cut down administrative burden for patients. These are small, but they reflect the kind of AI I believe in building.

I would love to bring this to MAIST.

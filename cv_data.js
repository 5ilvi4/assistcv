...
**Computer Science 101** | Stanford University | 2016 – 2018`
  ...
  {
    key:       "sterry",
    label:     "STERRY \u2013 Public Relations Head",
    company:   "STERRY",
    role:      "Public Relations Head",
    jdUrl:     "https://www.linkedin.com/jobs/view/4378911274/",
    dateAdded: "2026-03-16",
    coverLetter: `Dear STERRY Hiring Team,

I am applying for the Public Relations Head role at STERRY. My background sits at the intersection of brand communications, growth marketing, and data-driven campaign performance — built across a global consumer healthcare brand, a fintech platform with 1 million monthly active users, and a multinational AI-led merchant growth program with measurable revenue outcomes.

At Johnson & Johnson, I led the content architecture and brand communications infrastructure for the Global Marketing team — curating and maintaining brand guidelines, campaign assets, product information, and SOPs across global markets. I validated all AI-generated communications outputs before publication, effectively owning quality and accuracy for the team's external-facing content. This is the kind of brand management and reputational rigour a PR Head needs to bring.

My e-commerce and growth marketing track record is equally direct: at Philip Morris International, I led the rollout of two AI-powered merchant acquisition and retention programs that onboarded 12,000 merchants and generated 270 billion IDR in combined revenue within three months. At LinkAja, one of Indonesia's largest fintech platforms, I built and managed the marketing automation pipeline — designing user segmentation frameworks (RFM-based), running targeted campaign cohorts, and tracking retention and revenue metrics end-to-end. At Alodokter, with 1 million monthly users, I owned the content recommendation strategy across feed, articles, and health topics — using CTR and engagement data to drive content performance decisions.

These are campaigns I have run with measurable ROI, not communications work done in isolation from the data.

On the analytics and KOL management side: I am comfortable building measurement frameworks, defining KPIs for influencer and media campaigns, and connecting qualitative PR outcomes to quantitative revenue and engagement signals — which is increasingly the accountability standard for growth agencies.

I am completing a Master's in Medical Informatics at Stanford University School of Medicine (GPA 4.0) and am available for a remote role immediately. I would welcome the opportunity to discuss how I can lead STERRY's PR function with the rigour and commercial edge your clients need.
...
**AI Consultant — Knowledge Management** | Johnson & Johnson | 2025
- Led content architecture and brand communications infrastructure for J&J's Global Marketing team — curated and maintained brand guidelines, campaign assets, product information, and SOPs across global markets, ensuring accuracy and currency.
- Owned quality and validation of AI-generated communications outputs: tested all responses against real user queries before publication, maintaining brand integrity and reputational standards at launch and beyond.
- Drove user adoption and onboarding of a new communications platform (Microsoft Copilot / Teams) across the global team — designed onboarding materials and served as the communications lead for the rollout.

**Digital Transformation Manager (AI/ML)** | Philip Morris International | Jan 2023 – April 2023
- Led growth marketing programs for merchant acquisition and retention: two AI-driven channels (chatbot + callbot) onboarded 12,000 merchants and generated 270 billion IDR in combined revenue within three months.
- Designed and managed data governance framework for marketing performance reporting — ensuring integrity, accuracy, and auditability of campaign data for finance and growth stakeholders.

**AI/ML and Analytics - Senior Product Manager** | Alodokter | Jan 2022 – 2023
- Owned content strategy and distribution performance for Alodokter's 1-million-monthly-user platform: led the Health Articles Recommender and Feeds Recommender products, optimizing CTR and content engagement across mobile and web surfaces.
- Managed KOL and content performance analytics: defined engagement KPIs, ran A/B tests on content targeting strategies, and translated performance data into editorial and distribution recommendations for the marketing team.
- Led roadmap of 6 AI/ML products — organized 6 engineers and 2 data scientists; drove product iteration based on user behaviour and campaign analytics.

**Senior Data Analyst** | LinkAja – Big Data, AI and Anti-Fraud Eng. | 2020 – 2022
- Built marketing automation and user segmentation infrastructure for one of Indonesia's largest fintech platforms — designed RFM-based segmentation models, implemented campaign tracking via MixPanel and Braze, and delivered end-to-end growth, retention, and revenue analytics.
- Deployed and monitored SDK tracking across the full user journey: defined metrics, acceptance criteria, and reporting pipelines for Product, Marketing, and Sales Operations teams.

**Senior Technical Project Manager** | General Electric Healthcare | Sept 2023 – May 2025
- Led international communications and stakeholder management across a 20-country technology program — produced executive-level reporting for Asia, Africa, Latin America, Australia, Europe, the UK, and the Middle East.
- Awards: The Five Heartbeats Award in the category of "Deliver the Future of Healthcare" 2025

**Adjunct Lecturer - Data Analytics** | Binus (Bina Nusantara) University | June 2021 – June 2022
- Delivered Data Analytics curriculum including data storytelling and visualization — translated complex analytical concepts into accessible, compelling communications for undergraduate audiences.

### PROJECTS

**ColpoAI — AI Cervical Cancer Detection** | Personal / University of Limpopo Collaboration | 2025
- Built AI clinical tool and led stakeholder communications for a cross-institutional research collaboration; produced content and materials for a global health audience. Affiliated with University of Limpopo; funded by SAfAIDS and ASCCP.

**VibesCheck — Relationship Health Analyser** | Personal Research | 2025
- Designed and produced content for a consumer-facing AI product: defined messaging, user journey narrative, and communication of complex analytical outputs (28 dimensions, 13 interpersonal traits, health score) for non-technical audiences.

### SKILLS

**Brand Content Management & Editorial Strategy** | | Advanced
**Growth Marketing & Campaign Performance Analytics** | | Advanced
**Marketing Automation (MixPanel, Braze, AI-driven)** | | Advanced
**KOL / Influencer Campaign Analytics & ROI Measurement** | | Advanced
**SEO & Content Distribution Optimization** | | Intermediate
**Crisis Communication & Brand Reputation Management** | | Intermediate
**Data-Driven PR Measurement & Reporting** | | Advanced
**Stakeholder & Media Relations Management** | | Advanced
